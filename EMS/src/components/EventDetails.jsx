        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-8 ">
              ...
              {/* Our Partners and & Sponcers start here */}
              <div className="py-3">
                <h2 className="fs-4 fw-semibold">Our Partners & Sponcers</h2>
                <div className=" pc-5">
                  <div class="row align-items-center h-100">
                    <div class="logoslider rounded">
                      <div class="slider">
                        <div class="logos">
                          <div></div>
              ...
              {/* Our Partners and & Sponcers end here */}
              <div className="py-3">
                ...
                <div className="py-4 mt-5 px-4 rounded-5 bg-secondary-subtle">
                  <div className="d-flex gap-4 align-items-center mb-4">
                    ...
                    <p className="text-primary pt-3">
                      By National Indian Students and Alumni<br></br>Union UK
                    </p>
                  </div>
                  <p className="text-body-tertiary lh-lg">
                    ...
                    organisation for India and India-related student societies
                    in the UK and aim to bring a unified voice of India's
                    diaspora youth, on a single, international platform, promote
                    Indian culture and further the UK-India relationship by
                    fostering a dynamic youth-led leadership ecosystem.
                  </p>
                </div>
              </div>
            </div>
